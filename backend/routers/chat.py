...
from mcp_handlers.server import mcp_server, handle_list_tools, handle_call_tool
...
async def chat(
    ...
    try:
        ...
        try:
            prompt_path = Path(__file__).resolve().parents[1] / "llm_providers" / "system_prompt.txt"
