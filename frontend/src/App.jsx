...
import { AppShell, Group, Title, Text, Button, Container, ActionIcon, useMantineColorScheme, useComputedColorScheme, Avatar, Grid, Stack, SegmentedControl, Select } from '@mantine/core';
...
function App() {
  ...
  return (
    ...
    >
          ...
          <Group>
             ...
             {character ? (
                <Group>
                  ...
                  <Button onClick={handleLogin} variant="outline" color="blue">Change Character</Button>
      ...
      <AppShell.Main>
        <Container size="xl" fluid style={{ height: 'calc(100vh - 120px)', display: 'flex', flexDirection: 'column', padding: 0 }}>
           <div style={{ padding: '0.5rem 1rem', borderBottom: '1px solid var(--mantine-color-gray-3)' }}>
             <Text c="dimmed" size="sm">Backend Status: {message}</Text>
           </div>
           <div style={{ display: 'flex', flex: 1, gap: '1rem', padding: '1rem', minHeight: 0 }}>
              <div style={{ width: '25%', display: 'flex', flexDirection: 'column', minHeight: 0, gap: '1rem' }}>
                  ...
                  <div style={{ flexShrink: 0 }}>
                    <Text fw={600} size="sm" mb="xs">Order Type</Text>
                    <SegmentedControl
                      value={orderType}
