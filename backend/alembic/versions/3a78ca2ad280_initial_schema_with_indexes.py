...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_market_history_region_id"), "market_history", ["region_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_market_orders_region_id"), "market_orders", ["region_id"], unique=False
    )
    op.create_index(op.f("ix_market_orders_type_id"), "market_orders", ["type_id"], unique=False)
    op.create_index(
        "ix_market_orders_type_region_buy_issued",
        "market_orders",
        ["type_id", "region_id", "is_buy_order", "issued"],
        unique=False,
    )
    op.create_index(
        op.f("ix_market_orders_updated_at"), "market_orders", ["updated_at"], unique=False
    )
    op.create_table(
        "region_etags",
    ...
    op.create_index(
        op.f("ix_sde_market_groups_parent_group_id"),
        "sde_market_groups",
        ["parent_group_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_sde_solar_systems_region_id"), "sde_solar_systems", ["region_id"], unique=False
    )
    op.create_table(
        "sde_stations",
    ...
    op.create_index(
        op.f("ix_sde_stations_solar_system_id"), "sde_stations", ["solar_system_id"], unique=False
    )
    op.create_table(
        "sde_types",
    ...
    op.create_index(
        op.f("ix_sde_types_market_group_id"), "sde_types", ["market_group_id"], unique=False
    )
